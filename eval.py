...
def main(dataset_name, experiment_path, device_idx, split='test', save_vis=0, out_folder=None,
    ...
    if args.experiment_path is None:
        ...
        model_path = os.path.join(experiment_path, checkpoint_name)
...
def parse_arguments():
    ...
    parser.add_argument('--checkpoint_name', type=str, default='model_latest.pth',
                        help='Checkpoint file name inside --experiment_path (default: model_latest.pth)')
