...
OBJAVERSE_ROOT = "/mnt/e/reaserach/pattern/triplane/co3d" # Change this to your data directory
OBJAVERSE_LVIS_ANNOTATION_PATH = "/mnt/e/reaserach/pattern/triplane/co3d/lvis-annotations-filtered.json" # Change this to your filtering .json path
