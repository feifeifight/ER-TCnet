...
CO3D_RAW_ROOT = "/mnt/e/reaserach/pattern/triplane/co3d/hydrant_raw" # change to where your CO3D data resides
CO3D_OUT_ROOT = "/mnt/e/reaserach/pattern/triplane/co3d/co3d_preprocessed" # change to your folder here
...
def main(dataset_name, category):
    ...
    for sequence_name in tqdm.tqdm(sequence_names):
        ...
        try:
            ...
            print(f"[SKIP] Sequence {sequence_name} failed: {e}")
            continue  # 跳过这个序列，继续下一个
